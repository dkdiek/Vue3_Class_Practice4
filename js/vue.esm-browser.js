...
const devtoolsComponentAdded = /*#__PURE__*/ createDevtoolsHook(
  "component:added" /* COMPONENT_ADDED */
);
const devtoolsComponentUpdated = /*#__PURE__*/ createDevtoolsHook(
  "component:updated" /* COMPONENT_UPDATED */
);
const devtoolsComponentRemoved = /*#__PURE__*/ createDevtoolsHook(
    ...
    if ((vIf = findDir(slotElement, "if"))) {
      ...
      if (staticSlotName) {
        if (seenSlotNames.has(staticSlotName)) {
          context.onError(
            createCompilerError(35 /* X_V_SLOT_DUPLICATE_SLOT_NAMES */, dirLoc)
          );
          continue;
        }
...
const transformModel$1 = (dir, node, context) => {
  ...
  function checkDuplicatedValue() {
    ...
    if (value) {
      context.onError(
        createDOMCompilerError(54 /* X_V_MODEL_UNNECESSARY_VALUE */, value.loc)
      );
    }
  }
  const { tag } = node;
...
const ignoreSideEffectTags = (node, context) => {
  if (
    ...
    context.onError(
      createDOMCompilerError(57 /* X_IGNORED_SIDE_EFFECT_TAG */, node.loc)
    );
    context.removeNode();
  }
};
